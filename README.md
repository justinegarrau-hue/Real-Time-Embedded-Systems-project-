# Real-Time embededd systems Project

Code informations :

The c code product.c contains a function which calculate the product between two large randomly generated numbers x and y(between 1e5 and 1e7). I execute this function 10 billions of time to obtain an execute time in 1e-3 seconds. (explain in the report)
